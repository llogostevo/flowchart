...
export default function ProcessNode({ data, isConnectable, selected }: NodeProps) {
  ...
  return (
    <div className="relative">
      <div className="px-4 py-2 border-2 border-green-500 bg-green-50 min-w-[120px] text-center">
